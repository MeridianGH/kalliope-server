...
export function Home() {
  useEffect(() => {
    ...
    VanillaTilt.init(document.querySelectorAll('.commands-container > code'), { reverse: true, startX: 10, startY: 10, scale: 1.2 })
  }, [])
  return (
    <div id={'home'}>
      <section id={'features'}>
        ...
        <div className={'features-container'}>
          ...
          <div className={'feature-card'}>
            <div className={'feature-card-content'}>
              ...
              <h2>High quality</h2>
              <p>
                Kalliope is using the well established library LavaLink for high quality playback.
              </p>
            </div>
          </div>
          <div className={'feature-card'}>
            <div className={'feature-card-content'}>
              ...
              <p>
                Search up to five songs from YouTube and play one directly from Discord.
              </p>
            </div>
          </div>
          <div className={'feature-card'}>
